...
import { BarChart3, Mail, Lock, User, AlertCircle, Loader2, ArrowLeft } from 'lucide-react';
...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0c] px-4 relative py-20">
        {/* Background blobs */}
        ...
        <div className="max-w-md w-full relative">
            ...
            <div className="glass-card p-10 rounded-2xl border border-white/10 shadow-3xl">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <h1 className="text-3xl font-black text-center">Join AI BI Dash</h1>
                    <p className="text-gray-400 text-sm mt-2 font-medium text-center">Start generating insights from your data instantly</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2.5 px-1">Full Name</label>
